...
class LocationPermissionViewController: BaseViewController {
    override func viewDidLoad() {
        ...
        LocationManager.shared.requestLocationAuthorization { _ in
        }
    }
}
...
extension LocationPermissionViewController {
    ...
    private func generateContent(in parentView: UIView) {
        ...
        headerImageView.image = UIImage(named: "LocationStep")
        ...
        headerLabel.setLabel(with: onboardingLocationTitle, using: .h2)
        ...
        descriptionLabel.setLabel(with: onboardingLocationDescription, using: .grayDescriptionText)
