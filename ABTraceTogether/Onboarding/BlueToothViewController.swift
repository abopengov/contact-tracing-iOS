...
extension BluetoothViewController {
    ...
    private func generateContent(in parentView: UIView) {
        ...
        headerImageView.image = UIImage(named: "BluetoothStep")
        ...
        headerLabel.setLabel(with: onboardingBluetoothTitle, using: .h2)
        ...
        descriptionLabel.setLabel(with: onboardingBluetoothDescription, using: .grayDescriptionText)
