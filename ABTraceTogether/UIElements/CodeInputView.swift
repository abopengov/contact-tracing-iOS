...
open class CodeInputView: UIView {
    ...
    */
    // swiftlint:disable:next count_instead_number_of
    ...
    */
    open var textColor = Colors.ABBlue {
        didSet {
            setup()
        }
    }
    ...
    */
    open var font: UIFont? = UIFont(name: "Helvetica Neue Bold", size: 16)
    ...
    */
    private func didChange(_ backspaced: Bool = false) {
        ...
        if !labels.isEmpty, nextIndex < labels.count + 1 {
