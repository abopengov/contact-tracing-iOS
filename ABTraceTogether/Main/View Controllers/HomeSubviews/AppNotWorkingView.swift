...
class AppNotWorkingView: UIView {
    ...
    override func layoutSubviews() {
        ...
        turnBluetoothOnButton.setButton(with: homeGotoSettings, and: .secondaryClickout, buttonStyle: .secondaryMedium)
        allowBluetoothPermissionButton.setButton(with: homeGotoAppSettings, and: .secondaryClickout, buttonStyle: .secondaryMedium)
        allowLocationPermissionButton.setButton(with: homeGotoAppSettings, and: .secondaryClickout, buttonStyle: .secondaryMedium)
    }
