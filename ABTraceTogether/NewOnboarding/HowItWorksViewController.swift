...
extension HowItWorksViewController {
    ...
    private func generateContent(in parentView: UIStackView) {
        ...
        generateBulletItem(imageName: "RedCircleX", text: howItWorksWillNotSublabel1, parentView: parentView)
        generateBulletItem(imageName: "RedCircleX", text: howItWorksWillNotSublabel2, parentView: parentView)
    }
